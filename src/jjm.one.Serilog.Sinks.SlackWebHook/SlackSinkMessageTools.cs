...
public static class SlackSinkMessageTools
{
    ...
    public static List<SlackAttachment>? GenerateSlackMessageAttachments(LogEvent logEvent,
        IFormatProvider? formatProvider, object options)
    {
        // input check
        var slackSinkOptions = (SlackSinkOptions)options ?? throw new InvalidCastException();
        ...
        if (slackSinkOptions is { SlackAddShortInfoAttachment: true, SlackAddExtendedInfoAttachment: false })
        {
    ...
    public static List<Block>? GenerateSlackMessageBlocks(LogEvent logEvent, IFormatProvider? formatProvider,
        object options)
    {
        return null;
    }
